...
(function ($, Drupal) {
    ...
    Drupal.behaviors.exampleBehavior = {
        attach: function (context, settings) {
            ...
            $('#area-of-study-tabs').on('collapse.zf.tabs', function() {
                $('.area-of-study-nav').removeClass('area-of-study-nav--blue-bg');
            });

            $('#area-of-study-tabs').on('change.zf.tabs', function() {
                $('.area-of-study-nav').addClass('area-of-study-nav--blue-bg');
            });

            $('#area-of-study-dropdown').on('show.zf.dropdown', function() {
                $('#area-of-study-tabs .is-active a').click();
                $('.area-of-study-nav').addClass('area-of-study-nav--blue-bg');
            });

            $('#area-of-study-dropdown').on('hide.zf.dropdown', function() {
                $('.area-of-study-nav').removeClass('area-of-study-nav--blue-bg');
            });
            function bgVideo() {
                ...
                enquire.register("screen and (min-width: 768px)", {
                    ...
                    match : function() {
                        $("#bgVideo").YTPlayer({
                            onReady: function( player ) {
                                jQuery('.header-video').prepend('<button class="togglePlay command pause">Pause Video</button>');

                                jQuery('.togglePlay').click( function() {
                                    jQuery(this).toggleClass('play pause');

                                    // also toggle the text play/pause
                                    if (jQuery(this).hasClass('play')) {
                                        jQuery(this).text('Play Video');
                                    } else {
                                        jQuery(this).text('Pause Video');
                                    }

                                    jQuery('#bgVideo').YTPTogglePlay();
                                });
                    ...
                    unmatch : function() {
                        jQuery('.header-video .togglePlay').remove();
                    }
            ...
            $('.short-profile__more').click( function(event) {
                event.preventDefault();
                $(this).toggleClass('open');
                $(this).prev().slideToggle();
            });

            $('.library-hours__more').click( function(event) {
                event.preventDefault();
                $(this).toggleClass('open');
            ...
            function cardRow() {
                $('.card-row .carousel').slick({
                    ...
                    $('.slick-current').next().next().addClass('next-next-active');
                    $('.slick-current').next().addClass('next-active');
                }).on('beforeChange', function(event, slick, currentSlide, nextSlide){
                    $('.slick-slide').removeClass('next-next-active next-active');
            ...
            $('.card--statistic a').hover( function() {
                $(this).parents('.card--statistic').toggleClass('hover');
            });

            $('.card--news a').hover( function() {
                $(this).parents('.card--news').toggleClass('hover');
            });

            $('.more-content__read-more a').click( function(event) {
                event.preventDefault();
                $(this).parent('.read-more').parent('.more-content__read-more').prev('.more-content__collapsed-content').slideToggle('fast');
            ...
            $('.scholarship-link').hide();

            function addUpCostLineItems() {
                $('.program-cost-category__amount').each( function() {
                    var lineItems = $(this).parents("li.accordion-item:not('.hide')").find('.program-cost-line-item__amount');
                    var costCategoryTotal = 0;
                    $.each( lineItems, function() {
                        costCategoryTotal = costCategoryTotal + parseFloat($(this).attr('data-line-item'));
                    });
                    $(this).attr('data-cost-category', costCategoryTotal).text('$' + numberWithCommas(costCategoryTotal));
                });
            }

            addUpCostLineItems();

            function addUpTotalCost() {
                $('.program-cost-option__total-amount').each( function() {
                    var costCategories = $(this).parents('ul.accordion').find('.program-cost-category__amount');
                    var costOptionTotal = 0;
                    $.each( costCategories, function() {
                        costOptionTotal = costOptionTotal + parseFloat($(this).attr('data-cost-category'));
                    });
                    $(this).attr('data-cost-option-total', costOptionTotal).text('$' + numberWithCommas(costOptionTotal));
                });
            }

            addUpTotalCost();

            $('.program-cost-option__housing-option--commute').click(function(e) {
                e.preventDefault();
                $('.program-cost-option__housing-option').removeClass('active');
                $('.program-cost-option__housing-option--commute').addClass('active');
                $('.program-cost-option__housing-costs').addClass('hide');
                addUpCostLineItems();
                addUpTotalCost();
                estimatedCost();
            });

            $('.program-cost-option__housing-option--on-campus').click(function(e) {
                e.preventDefault();
                $('.program-cost-option__housing-option').removeClass('active');
                $('.program-cost-option__housing-option--on-campus').addClass('active');
                $('.program-cost-option__housing-costs').removeClass('hide');
                addUpCostLineItems();
                addUpTotalCost();
                estimatedCost();
            });

            $('input.gpa').bind('keyup', function() {
                var value = $(this).val();
                $('input.gpa').val(value).change();
            });

            function calcScholarshipOptional() {
                $('.program-cost__scholarship-calculator--optional').each( function() {
                    var gpaField = $(this).find('.gpa');
                    var gpa;
                    var parentTabPanel = $(this).parents('.tabs-panel');
                    var scholarship = parentTabPanel.find('.program-cost__scholarship-amount');
                    var totalCost = parentTabPanel.find('.program-cost-option__total-amount').attr('data-cost-option-total');
                    var estimatedCost = parentTabPanel.find('.program-cost-option__estimated-cost-amount')
                    var scholarshipNone = parentTabPanel.find('.program-cost__scholarship-none');
                    var scholarshipRank1 = parentTabPanel.find('.scholarships-by-rank_scholarship--rank1');
                    var scholarshipRank2 = parentTabPanel.find('.scholarships-by-rank_scholarship--rank2');
                    var scholarshipRank3 = parentTabPanel.find('.scholarships-by-rank_scholarship--rank3');
                    var scholarshipRank4 = parentTabPanel.find('.scholarships-by-rank_scholarship--rank4');
                    var scholarshipRank1Value = parseFloat(parentTabPanel.find('.scholarships-by-rank').attr('data-rank1-value'));
                    var scholarshipRank2Value = parseFloat(parentTabPanel.find('.scholarships-by-rank').attr('data-rank2-value'));
                    var scholarshipRank3Value = parseFloat(parentTabPanel.find('.scholarships-by-rank').attr('data-rank3-value'));
                    var scholarshipRank4Value = parseFloat(parentTabPanel.find('.scholarships-by-rank').attr('data-rank4-value'));

                    scholarshipNone.hide();
                    scholarship.hide();
                    scholarshipRank1.hide();
                    scholarshipRank2.hide();
                    scholarshipRank3.hide();
                    scholarshipRank4.hide();

                    $(this).find('input').bind('keyup change', function() {


                        var totalCost = getTotalCost($(this));
                        ...
                        scholarshipRank3.hide();
                        scholarshipRank4.hide();
                        totalCost = parentTabPanel.find('.program-cost-option__total-amount').attr('data-cost-option-total');

                        gpa = parseFloat(gpaField.val());

                        if (gpa >= 3.5) {
                            scholarship.text('-' + numberWithCommas(scholarshipRank1Value));
                            scholarship.attr('data-scholarship-amount', scholarshipRank1Value);
                            estimatedCost.text('$' + numberWithCommas(parseFloat(totalCost) - scholarshipRank1Value));
                            $('.scholarship-link').show();
                            scholarshipRank1.show();
                            scholarship.show();
                        }

                        else if (gpa >= 3.0) {
                            scholarship.text('-' + numberWithCommas(scholarshipRank2Value));
                            scholarship.attr('data-scholarship-amount', scholarshipRank2Value);
                            estimatedCost.text('$' + numberWithCommas(parseFloat(totalCost) - scholarshipRank2Value));
                            $('.scholarship-link').show();
                            scholarshipRank2.show();
                            scholarship.show();
                        }

                        else if (gpa >= 2.7) {
                            scholarship.text('-' + numberWithCommas(scholarshipRank3Value));
                            scholarship.attr('data-scholarship-amount', scholarshipRank3Value);
                            estimatedCost.text('$' + numberWithCommas(parseFloat(totalCost) - scholarshipRank3Value));
                            $('.scholarship-link').show();
                            scholarshipRank3.show();
                            scholarship.show();
                        }

                        else if (gpa >= 2.5) {
                            if(isNaN(scholarshipRank4Value)) {
                                scholarship.hide().text('');
                                scholarship.attr('data-scholarship-amount', 0);
                                scholarshipNone.show();
                                estimatedCost.text('$' + numberWithCommas(parseFloat(totalCost)));

                            } else {
                                scholarship.text('-' + numberWithCommas(scholarshipRank4Value));
                                scholarship.attr('data-scholarship-amount', scholarshipRank4Value);
                                estimatedCost.text('$' + numberWithCommas(parseFloat(totalCost) - scholarshipRank4Value));
                                $('.scholarship-link').show();
                                scholarshipRank4.show();
                                scholarship.show();
                            }
                        }
            ...
            calcScholarshipOptional();

            function estimatedCost() {
                $('.program-cost-option__estimated-cost-amount').each( function() {
                    var totalCost = $(this).parents('.tabs-panel').find('.program-cost-option__total-amount').attr('data-cost-option-total');
                    var scholarship = $(this).parents('.tabs-panel').find('.program-cost__scholarship-amount').attr('data-scholarship-amount');

                    if (scholarship) {
                        var estimateCost = parseFloat(totalCost) - parseFloat(scholarship);
                    }
                    else {
                        var estimateCost = parseFloat(totalCost);
                    }
                    $(this).text('$' + numberWithCommas(estimateCost));
                });
            }

            function getTotalCost(item) {
                return item.parents('.tabs-panel').find('.program-cost-option__total-amount').attr('data-cost-option-total');
            }
            ...
            $('.program-cost__score-toggle').click( function(e) {
                e.preventDefault;
                $('.program-cost__score-toggle').removeClass('active');
                $(this).addClass('active');
                $(this).parent().parent().siblings('input').val("").keyup().hide();
                var inputClass = $(this).attr('data-show');
                $(this).parent().parent().siblings('.' + inputClass).show();
                estimatedCost();
            });
            ...
            if ($('#edit-field-event-type-target-id input:checked').length > 0) {

                $('#edit-field-event-type-target-id input:checked').each( function() {
                    $('a[data-event-type-id="0"]').removeClass('active');
                    $('a[data-event-type-id="' + $(this).val() + '"]').addClass('active');
                });
            }


            $('.view-id-event_type').find('a').each( function() {
                var viewMode = $('.view-content-field-start-date-on-calendar').attr('data-current-view-mode');
                var arg = $('.view-content-field-start-date-on-calendar').attr('data-current-calendar-arg');
                var tid = $(this).attr('data-event-type-id');

                if (tid > 0) {
                    $(this).attr('href', '/events/' + viewMode + '/' + arg + '?field_event_type_target_id[' + tid + ']=' + tid);
                }

                else {
                    $(this).attr('href', '/events/' + viewMode + '/' + arg);
                }

                $(this).click( function() {
                    $('.view-id-event_type').find('a').removeClass('active');
                    $(this).addClass('active');
                });
            });
            ...
            if($('body').hasClass('section-events')) {
                ...
                var eventsPath = window.location.pathname.split('/');
                var eventsRangeContext = eventsPath[2];
                var eventsRangeValue = eventsPath[3];

                if (eventsRangeValue) {

                    if (eventsRangeContext == 'week') {
                        var month = moment(eventsRangeValue, "YYYYWW").format('YYYYMM');
                        var day = moment(eventsRangeValue, "YYYYWW").format('YYYYMMDD');
                        var week = eventsRangeValue;
                    }

                    else if (eventsRangeContext == 'day') {
                        var month = moment(eventsRangeValue, "YYYYMMDD").format('YYYYMM');
                        var week = moment(eventsRangeValue, "YYYYMMDD").format('YYYYWW');
                        var day = eventsRangeValue;
                    }

                    else if (eventsRangeContext == 'month') {
                        var week = moment(eventsRangeValue, "YYYYMM").format('YYYYWW');
                        var day = moment(eventsRangeValue, "YYYYMM").format('YYYYMMDD');
                        var month = eventsRangeValue;
                    }

                    $('#calendar-month-view-link').attr('href', '/events/month/' + month + filters);
                    $('#calendar-week-view-link').attr('href', '/events/week/' + week + filters);
                    $('#calendar-day-view-link').attr('href', '/events/day/' + day + filters);

                } else {
                    $('#calendar-month-view-link').attr('href', '/events/month' + filters);
                    $('#calendar-week-view-link').attr('href', '/events/week' + filters);
                    $('#calendar-day-view-link').attr('href', '/events/day' + filters);
                }

                var viewTitle;

                if (eventsRangeContext == 'day') {
                    viewTitle = moment($('.events-list__body').find('.view-header').find('h3.view-title').text()).format('ddd, MMMM D, YYYY')
                }
                else {
                    viewTitle = $('.events-list__body').find('.view-header').find('h3.view-title').text();
                }

                $('.view-header').find('li.current-page').text(viewTitle);
            }

            $('.view-events-landing-page .view-content').slick({
                infinite: false,
                slidesToShow: 3,
                slidesToScroll: 1,
                dots: false,
            ...
            $('.view-content-field-start-date-on-calendar .views-exposed-form').find('legend').each( function() {
                var legend = $(this).find('> span');
                var legendText = legend.text();

                legend.wrap('<a class="legend-link" href="#" aria-expanded="false" aria-label="toggle ' + legendText + ' fieldset" />');
                var legendLink = $(this).find('> a');
                legendLink.click(function() {
                    var legendStatus = legendLink.attr('aria-expanded');
                    if (legendStatus == 'false') {
                        legendLink.attr('aria-expanded','true');
                    } else {
                        legendLink.attr('aria-expanded','false');
                    }
                    legendParent = $(this).closest('legend');
                    legendParent.toggleClass('active');
                    legendParent.next('.fieldset-wrapper').slideToggle('fast');
                });
            });
            ...
            $('.view-content-field-start-date-on-calendar .views-exposed-form').find('input[type=checkbox]').change( function() {
                $('#edit-submit-content-field-start-date-on-calendar').trigger('click');
            });


            $('.event-search__share').click( function(e) {
                e.preventDefault();
                $(this).find('.block-sharethis').slideToggle('fast');
            });
            $('.atcb-link').click( function(e) {
                e.preventDefault();
            });

            $('.events-list__search form').on('submit', function(e) {
                e.preventDefault();
                var searchText = $('#search-events').val();
                window.location = '/search?search=' + searchText + '&f%5B0%5D=rendered_html_output%3AEvents';
            });

            $('#skip-to-event-listing').click(function(){
                if ($('#event-results a').first().length) {
                    $('#event-results a').first().focus();
                } else {
                    $('.events-list__body a').first().focus();
                }
            });

// Reset the degree_level and program type facets when graduate or undergraduate links are clicked.

            $('ul[data-drupal-facet-id="degree_level"] a').click( function(e) {
                e.preventDefault();
                var path = removeDegreeOfferedProgramType($(this).attr('href'));
                window.location.href = path;
            });

            $('ul[data-drupal-facet-id="degree_level_by_school"] a').click( function(e) {
                e.preventDefault();
                var path = removeDegreeOfferedProgramType($(this).attr('href')).replace(/\/program_type_by_school\/[a-zA-Z0-9.\-_]*/i, '');
                window.location.href = path;
            });

// Reset the degree_level and program type facets when area of study is changed.

            $('ul[data-drupal-facet-id="area_of_study"] a').click( function(e) {
                e.preventDefault();
                var path = removeDegreeOfferedProgramType($(this).attr('href'));
                window.location.href = path;
            });

// Reset the degree_level and program type facets when school is changed.

            $('ul[data-drupal-facet-id="schools"] a').click( function(e) {
                e.preventDefault();
                var path = removeDegreeOfferedProgramType($(this).attr('href'));
                window.location.href = path;
            });
...
// Reset facets link
            ...
            $('.reset-facets a').click( function(e) {
                e.preventDefault();
                var currentPath = window.location.href;
                var path = removeDegreeOfferedProgramType(currentPath);
                window.location.href = path;
            });


// Disable unselect links for degree level

            $('ul[data-drupal-facet-id="degree_level"] a.is-active').unbind( "click" ).click( function(e) {
                e.preventDefault();
            });


            $('ul[data-drupal-facet-id="degree_level_by_school"] a.is-active').unbind( "click" ).click( function(e) {
                e.preventDefault();
            });

// Disable unselect links for area of study

            $('ul[data-drupal-facet-id="area_of_study"] a.is-active').unbind( "click" ).click( function(e) {
                e.preventDefault();
            });

// Disable unselect links for school

            $('ul[data-drupal-facet-id="schools"] a.is-active').unbind( "click" ).click( function(e) {
                e.preventDefault();
            });

// Set the view grouped results title to include the Area of Study

            var area_of_study_label = $('#block-areaofstudy').find('a.is-active').find('.facet-item__value').text();

            $('.explore-academics__area-of-study-header').each( function() {
                $(this).text(area_of_study_label);
            });


// Set the view grouped results title to include the Area of Study

            var schools_label = $('#block-schools-2').find('a.is-active').find('.facet-item__value').text();

            $('.explore-academics__schools-header').each( function() {
                $(this).text(schools_label);
            });


            function removeDegreeOfferedProgramType(value) {
                var newValue = value
                    .replace(/\/location\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/program-type\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education-goals\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/teach-subject-level\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education-where\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education-location\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/location_by_school\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education_goals_by_school\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education_teach_by_teach\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education_where_teach_by_school\/[a-zA-Z0-9.\-_]*/i, '')
                    .replace(/\/education_where_study_by_school\/[a-zA-Z0-9.\-_]*/i, '');

                return newValue;
            }

            var explorePath = window.location.pathname.split('/');

            if(explorePath[4] == 'education' && explorePath[6] == 'graduate'){
                $('#block-programtype').hide();
                $('#block-location').hide();
            }

            if($('a[data-drupal-facet-item-id="schools-261"].is-active').length && $('a[data-drupal-facet-item-id="degree_level_by_school-41"].is-active').length) {
                $('#block-programtype-2').hide();
                $('#block-location-2').hide();
            }

            $('#show-academics-explore__header-dropdown').click( function(e) {
                e.preventDefault();
                $('#academics-explore__header-dropdown').slideDown('fast');
            });

            $('#academics-explore__header-dropdown').find('a.is-active').click( function(e) {
                $('#academics-explore__header-dropdown').slideUp('fast');
            });

            $('.explore-acadmics-result__teaser-toggle').each( function() {
                $(this).unbind().click(function(e) {
                    e.preventDefault();
                    $(this).toggleClass('open').next('.explore-acadmics-result__teaser').stop().slideToggle();
            ...
            enquire.register("(max-width:767px)", {
                match : function() {
                    $('#toggle-explore-filters').unbind( "click" ).click( function(e) {
                        e.preventDefault();
                        $(this).toggleClass('open');
                        $('#explore-filters').slideToggle('fast');
                    });
                },

                unmatch : function() {
                    $('#toggle-explore-filters').unbind( "click" );
                    $('#explore-filters').show();
                }
            ...
            function facultyCards() {
                ...
                setTimeout(function() {
                    $('.slick-dots li').removeAttr('role').removeAttr('aria-selected');
                }, 2000);

                $('.launch-faculty-modal').click( function() {
                    var initialSlide = parseInt($(this).parents('.slide-item').attr('data-loop-index'));
                    $('#launch-faculty-modal .modal-faculty-content').slick('slickGoTo', initialSlide);
                });

                $('#launch-faculty-modal .modal-faculty-content').slick({
                    infinite: false
                });

                $('[data-reveal]').on('open.zf.reveal', function() {
                    $('.modal-faculty-content').resize();
                });
            }
            ...
            function gallery() {
                $('.gallery--row .media-items').each( function() {
                ...
                $('.gallery--full-width .media-items').addClass('hello-world').each( function() {
                    $(this).not('.slick-initialized').slick({
                        infinite: false,
                        adaptiveHeight: true
                    });
                ...
                $('.launch-gallery__content').each( function() {

                    $(this).on('lity:ready', function(event, instance) {
                        $(this).find('.media-items').not('.slick-initialized').each( function() {
                            $(this).slick({
                                infinite: true
                            });
                        });
                ...
                $('.gallery__placeholder-slide').height($('.gallery__placeholder-slide').next().find('.slick-current .field-media--image').height());
            ...
            enquire.register("(min-width:1024px)", {
                match : function() {
                    ...
                    $('#guide-nav').find('a[href*="#"]:not([href="#"])').unbind( "click" ).click(function() {

                        $('#guide-nav').find('a').removeClass('active');
                        $(this).addClass('active');
            ...
            enquire.register("(max-width:767px)", {
                match : function() {
                    $('.local-nav--collapse-mobile').each( function() {
                        $(this).find('h2').unbind('click').click( function() {
                            $(this).toggleClass('open');
                            $(this).parents('.local-nav--collapse-mobile').find('.guide-content__body').slideToggle('fast');
                        });
                    });
                },
            ...
            $('#guide-modal').find('select').each( function() {
                $(this).change( function() {

                    var guidePathBuilder = '';

                    $('#guide-modal').find('select').each( function() {
                        guidePathBuilder = guidePathBuilder + '-' + $(this).val();
                    });

                    guidePathBuilder = 'data' + guidePathBuilder;

                    guideButton = $('#guide-modal').find('a.button');

                    guidePath = guideButton.attr(guidePathBuilder);

                    guideButton.attr('href', '/node/' + guidePath);

                });
            });

            $('.search-page-header--news').find('input').attr('placeholder', 'Search News');
            $('.search-page-header--academics').find('input').attr('placeholder', 'Search degrees and programs');
            $('.news-landing-page').find('.pager__item.button-wrapper').find('span').text('Load More News Stories');

            $('#block-exposedformacquia-searchpage-2').find('input.form-text').attr('id', 'edit-search-2');
            $('#block-exposedformacquia-searchpage-2').find('label').attr('for', 'edit-search-2');
            $('#block-exposedformacquia-searchpage-2').find('div.form-actions').attr('id', 'edit-actions-2');
            $('#block-exposedformacquia-searchpage-2').find('input.form-submit[value=Search]').attr('id', 'edit-submit-acquia-search-2');
            $('#block-exposedformacquia-searchpage-2').find('input.form-submit[value=Reset]').attr('id', 'edit-reset-2');
            $('#block-exposedformacquia-searchpage-2').find('#views-exposed-form-acquia-search-page').attr('id', 'views-exposed-form-acquia-search-page-2');


            $('.form-actions.js-form-wrapper.form-wrapper').each( function() {
                var parentForm = $(this).parents('form');
                $(this).attr('id', 'edit-actions-' + parentForm.attr('id'));
            });
            ...
            function linkedImages() {
                ...
                $('.homepage__main-feature__image').on('click', function() {
                    var link = $(this).closest('.homepage__main-feature__container').find('.homepage__main-feature__content h2 a').attr('href');
                    window.location=link;
                    return false;
                });

                $('.homepage__secondary-feature__image').on('click', function() {
                    var link = $(this).closest('.homepage__secondary-feature__container').find('.homepage__secondary-feature__content h3 a').attr('href');
                    window.location=link;
                    return false;
                });

                $('.promotional-story__image-linked').on('click', function() {
                    var link = $(this).closest('.promotional-story').find('.promotional-story__content .story-title a').attr('href');
                    window.location=link;
                    return false;
                });

                $('.visual_landing_page_section__image').on('click', function() {
                    var link = $(this).next('.visual_landing_page_section__content').find('h2 a').attr('href');
                    window.location=link;
                    return false;
                });
            ...
            $('#toggle-local-mobile-nav').click( function() {
            ...
            if (!$.trim( $('.local-mobile-nav__nav').html() ).length) {
                $('#toggle-local-mobile-nav').hide();
            }

            $('.search-main-menu__close-button').unbind('click').bind('click', function(event) {
                event.preventDefault();
                $('#block-exposedformacquia-searchpage').slideUp(100);
                $('.toggle-search').removeClass('active').removeClass('hide');
                $('.toggle-search > a.icon-search').focus();
            });

            $('#close-mega-menu').click( function() {
                $('#mega-menu').slideUp('fast');
                $('.toggle-mega-menu').attr('aria-expanded','false');
                $(this).closest('.has-submenu.toggle-mega-menu').find('> a').focus();
            });

            $('#close-mobile-menu').on('click', function() {
                $('#main-menu').hide();
                $('.title-bar button.menu-icon').focus();
            });

            enquire.register("(min-width:768px)", {
                match : function() {
                    $('.toggle-mega-menu > a').unbind('click').bind('click', function(event) {
                        event.preventDefault();
                        $('#mega-menu').slideToggle(100);

                        if ($(this).parent('[aria-expanded="false"]').length) {
                    ...
                    $('.toggle-search').unbind( 'click' ).click( function(event) {
                        event.preventDefault();
                        $('#mega-menu').slideUp(100);
                        $('.toggle-mega-menu').attr('aria-expanded','false');
                        $('#block-exposedformacquia-searchpage').slideToggle(100);
                        $(this).toggleClass('active');
                        if ($('.toggle-search[aria-expanded="false"]').length) {
                            $(this).attr('aria-expanded','true');
                            $('#main-menu input.form-text').focus();
                        } else {
                            $(this).attr('aria-expanded','false');
                            $(this).focus();
                        }
            ...
            enquire.register("(max-width:767px)", {
                match : function() {
                    $('.toggle-mega-menu > a').unbind( 'click' );

                    $('.toggle-search').unbind( 'click' ).click( function(event) {
                        event.preventDefault();
                        $('#block-exposedformacquia-searchpage').slideDown(200);
                    ...
                    $('.search-main-menu__close-button').unbind('click').bind('click', function(event) {
                        event.preventDefault();
                        $('#block-exposedformacquia-searchpage').slideUp(200);
                        $('.toggle-search').removeClass('active').removeClass('hide');
                        $('.toggle-search > a.icon-search').focus();
                    });

                    //  move search block to top on mobile
                    $('.top-bar-right #block-exposedformacquia-searchpage').prependTo('.top-bar-right');
                },
                unmatch : function() {
                    //  move search block to bottom on non-mobile (in case of zoom / accessibility)
                    $('.top-bar-right #block-exposedformacquia-searchpage').appendTo('.top-bar-right');
                }
            });

            function mobileFormToggle() {

                enquire.register("screen and (max-width: 767px)", {

                    match : function() {

                        $('#ad-form').appendTo('.off-canvas-content');

                    },

                    unmatch : function() {

                        $('#ad-form').appendTo('.ad-form-grid-column');
            ...
            $('.search-page-header--news form').on('submit', function(e) {
                e.preventDefault();
                var searchText = $('#search-news').val();
                window.location = '/search?search=' + searchText + '&f%5B0%5D=rendered_html_output%3ANews';
            });

            $('.onboarding-content__close').click( function(event) {
                event.preventDefault();
                $(this).parents('.onboarding-content').slideUp('fast');
            });
            function programNav() {
                ...
                enquire.register("screen and (min-width: 768px)", {
                    ...
                    match : function() {
                        ...
                        $('#person-menu').find('a[href*="#"]:not([href="#"])').click(function() {
                            var menuLink = $(this);
                            $('#person-menu').find('a').addClass('hide-border');
                            menuLink.addClass('show-border');
                            if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
                                var target = $(this.hash);
                                target = target.length ? target : $('[name=' + this.hash.slice(1) +']');
                                if (target.length) {
                                    $('html, body').animate({
                                        ...
                                        $('#person-menu').find('a').removeClass('hide-border');
                                        $('#person-menu').find('a.active').removeClass('active');
                                        menuLink.addClass('active');
                                        $('#person-menu').find('a').removeClass('show-border');
                                    });
                                    return false;
                                }
                            }
                        ...
                        $('.person-section').each( function() {
                            var className = $(this).attr('id');
                            var waypoint = new Waypoint({
                                element: document.getElementById(className),
                                handler: function() {
                                    $('#person-menu').find('a.active').removeClass('active');
                                    $('#person-menu a.' + className).addClass('active');
                                },
                                offset: '10%'
                            });
                        });
            ...
            $('#pre-populate-gecko').submit( function(e) {
                e.preventDefault();

                var iframe = $('#request-more-info').find('iframe');

                if (iframe.length) {
                    var path = iframe.attr('src').split("?");
                    var path = path[0] + '?email=' + $(this).find('input').val();

                    iframe.attr('src', path);

                    $('#request-more-info').foundation('open');
                }

                else {
                    $('.request-more-info__body').find('input#email').val($(this).find('input').val());
                    $('#request-more-info').foundation('open');
                }

            });

            function programFormToggle() {
                ...
                enquire.register("screen and (min-width: 768px)", {
                    ...
                    match : function() {
                        $('#program-curriculum__toggle').hide();
                        $('.desktop .request-more-info--inline > .read-more:first-child').show();
                        $('.desktop .request-more-info__wrapper').show();
                        $('.desktop .program-curriculum--inline-request-form .program-curriculum__wrapper').hide();
                    },

                    unmatch : function() {
                        $('.desktop .request-more-info__wrapper').hide();
                        $('.desktop .program-curriculum__wrapper').show();
                    }

                });


                $('#program-curriculum__toggle').click( function(e) {
                    e.preventDefault();
                    $(this).hide();
                    $('.desktop .request-more-info--inline > .read-more:first-child').show();
                    $('.desktop .request-more-info__wrapper').slideToggle();
                    $('.desktop .program-curriculum__wrapper').slideToggle();
                });

                $('#request-more-info__toggle').click( function(e) {
                    e.preventDefault();
                    $('.desktop .request-more-info--inline > .read-more:first-child').hide();
                    $('#program-curriculum__toggle').show();
                    $('.desktop .request-more-info__wrapper').slideToggle();
                    $('.desktop .program-curriculum__wrapper').slideToggle();
                });
            ...
            $('.program-grouping__title').click( function(event) {
                event.preventDefault();
                $(this).toggleClass('open');
                $(this).siblings('.program-grouping__slidedown').slideToggle('fast');
            });
            $('#program-menu').find('a[href*="#"]:not([href="#"])').click(function() {
                var menuLink = $(this);
                $('#program-menu').find('a').addClass('hide-border');
                menuLink.addClass('show-border');
                if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
                    var target = $(this.hash);
                    target.focus();
                    ...
                    if (target.length) {
                        $('html, body').animate({
                            ...
                            $('#program-menu').find('a').removeClass('hide-border');
                            $('#program-menu').find('a.active').removeClass('active');
                            menuLink.addClass('active');
                            $('#program-menu').find('a').removeClass('show-border');
                        });
                        return false;
                    }
                }
            ...
            $('.program-section').each( function() {
                ...
                var waypoint = new Waypoint({
                    ...
                    handler: function() {
                        $('#program-menu').find('a.active').removeClass('active');
                        $('#program-menu a.' + className).addClass('active');
                    },
                    offset: '10%'
                });
            });
            ...
            function bgSwap() {
                ...
                var panel = $('[data-imgbg]'),
                    ...
                    narrow = '(min-width: 560px) and (max-width: 849px)',
            ...
            function siteAlert() {
                ...
                $('#site-alert .close-button').on("click", function() {
                    var cookieChangedTime = $(this).parents('#site-alert').attr('data-changed-time');
                    $.cookie('lesley-site-alert' + changedTime, 'closed', { expires: 7 })
                });

                var changedTime = $('#site-alert').attr('data-changed-time');

                var checkCookie = $.cookie('lesley-site-alert' + changedTime);
            ...
            function skipLink() {
                ...
                // school, page, node--academic-menu
                if ($('.page-header').length) {
                    $('.body-content').prepend($('#main-content'));
                }

                // audience landing page
                if ($('.node--type-audience-landing-page').length) {
                    $('.audience-page__header').before($('#main-content'));
                }

                // audience
                if ($('.node--type-audience-content-page').length) {
                    $('.audience-page__body').before($('#main-content'));
                }

                // search page
                if ($('.views-page.path-search').length) {
                    $('.search-results').before($('#main-content'));
                }

                // Audience page
                if ($('.node--type-audience-content-page').length && $('.audience-page__local-nav').length) {
                    $('.audience-page__page-title').before($('#main-content'));
                }
            ...
            function stickyNav() {
                ...
                enquire.register("screen and (min-width: 1024px)", {
                    ...
                    match : function() {
                        if (!($('body').hasClass('node--type-person')) && !($('body').hasClass('node--type-program'))) {
                    ...
                    unmatch : function() {
                        $(window).off('scroll');
                        $("#top-bar-sticky-container").removeClass('stuck');
                        $("#top-bar-sticky-container--inner").removeClass('sticky is-at-top is-stuck');
                    },
                ...
                function navSlide() {
                    ...
                    if (scroll_top >= 38) {
                        $("#top-bar-sticky-container").addClass('stuck');
                        $("#top-bar-sticky-container--inner").addClass('sticky is-at-top is-stuck');
                ...
                $( window ).on('load', function() {
                    ...
                    setTimeout(function() {
                        ...
                        $('.atcb-link').each(function() {
                            $(this).removeAttr('tabindex').attr('href' , '#');
                        });
